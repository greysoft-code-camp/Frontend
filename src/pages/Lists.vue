<template>
 ...
 <div class="row">
    ...
    <q-card class="q-ml-xl q-mt-lg q-pa-md" style="width:20%" v-for="list in list" :key="list.id">
      ...
      <q-list class="q-mt-md">
        <q-item clickable v-ripple v-for="n in 3" :key="n">
          <q-item-section>
            <q-item-label> List Item </q-item-label>
          </q-item-section>
        </q-item>
      </q-list>
      ...
      <q-dialog v-model="itemShow">
          <q-card>
            <q-card-section>
              ...
              <q-card-section class="q-pt-none">
                <q-input name="text" outlined v-model="listItemName" />
              </q-card-section>

              <q-card-actions align="right">
                <q-btn type = "submit" label="Add" color="primary" v-close-popup @click="addListItem" />
              </q-card-actions>
          </q-card>
        </q-dialog>
